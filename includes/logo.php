<a href="<?php echo home_url(); ?>">
    ...
    if( !empty( $pearl_site_logo ) ) :
    	...
    	$mobile_url = $pearl_footer_logo['url'];
    ?>
	<h1 class="site__logo full" style="background-image: url(<?php echo $url; ?>)">
		<span class="ir"><?php echo bloginfo('name'); ?></span>
	</h1>
	<h1 class="site__logo mobile" style="background-image: url(<?php echo $mobile_url; ?>)">
		<span class="ir"><?php echo bloginfo('name'); ?></span>
	</h1>
    <?php else : ?>
