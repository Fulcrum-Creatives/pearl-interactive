...
<div class="upw-posts hfeed">
  ...
  <?php if ($upw_query->have_posts()) : ?>
      ...
      <?php while ($upw_query->have_posts()) : $upw_query->the_post(); ?>
        ...
        <article <?php post_class($current_post); ?> aria-labelledby="footer-section-heading-<?php echo $post->ID; ?>">
          ...
          <header>
            ...
            <?php if (get_the_title() && $instance['show_title']) : ?>
              <h3 id="footer-section-heading-<?php echo $post->ID; ?>" class="entry-title">
                <a href="<?php the_permalink(); ?>" rel="bookmark">
